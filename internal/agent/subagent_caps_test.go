...
func TestResolveChildCaps_RoleResolves(t *testing.T) {
	r := &SubAgentRunner{parentCaps: typecalc.CapsRoot}
...
func TestResolveChildCaps_RejectsSupersetOfParent(t *testing.T) {
	...
	// must be refused.
	r := &SubAgentRunner{parentCaps: typecalc.CapSet{"run_tool:graph_validate"}}
...
func TestResolveChildCaps_AllowsSubset(t *testing.T) {
	r := &SubAgentRunner{parentCaps: typecalc.CapSet{
		"read_file:*", "run_tool:*",
	}}
